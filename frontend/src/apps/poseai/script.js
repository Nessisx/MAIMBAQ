...
//  Adaptado para integración en MAIMBAQ
// ============================================================
...
const TM_URL = "./"; // model.json y metadata.json en la misma carpeta
...
extraStyles.textContent = `
  ...
  .r-bar-label { color:var(--text); }
  .r-bar-pct   { color:var(--text-muted); text-align:right; }
  .r-bar-track {
  ...
  .status-line.error { color:#e53935; }
